...
ClickHouse is packaged as two UPM components: `clickhouse` and `clickhouse-keeper`. Each service group selects UPM-managed ZooKeeper 3.8.4 or a matching-version Keeper, which is provisioned as a separate UnitSet when selected. Keeper packages use the matching UPM versions: `21.8.15.7`, `23.8.16.40`, `25.8.29.51`, and `26.3.9.8`.
...
| **ClickHouse**      | 21.8.15.7, 23.8.16.40, 25.8.29.51, 26.3.9.8 | Analytics database with ZooKeeper or Keeper-backed replication | ✅ Stable |
| **ClickHouse Keeper** | 21.8.15.7, 23.8.16.40, 25.8.29.51, 26.3.9.8 | Optional coordination service for ClickHouse UnitSets | ✅ Stable |
