# MySQL Router Community 8.4.5 - UPM Package Definition
...
**MySQL Router Community 8.4.5 UPM Software Package & Import Template**
...
This package defines the MySQL Router Community 8.4.5 software image and import template for the UPM (Unit Package Manager) system. It provides the foundational templates and configurations required to deploy MySQL Router instances within the UPM ecosystem.
...
**Software Image Definition**: Provides the MySQL Router Community 8.4.5 container image specification and configuration templates.
...
apiVersion: v2
appVersion: 8.4.5
name: mysql-router-community-8.4.5
version: 1.0.0
...
helm install --namespace=upm-system upm-packages-mysql-router-community-8.4.5 upm-packages/mysql-router-community-8.4.5

# Verify package installation
helm status upm-packages-mysql-router-community-8.4.5 --namespace=upm-system
```
...
Comprehensive parameter metadata with validation rules and bilingual documentation for all MySQL Router 8.4.5 configuration parameters.
