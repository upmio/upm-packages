# ProxySQL Community 2.7.2 - UPM Package Definition
...
**ProxySQL Community 2.7.2 UPM Software Package & Import Template**
...
This package defines the ProxySQL Community 2.7.2 software image and import template for the UPM (Unit Package Manager) system. It provides the foundational templates and configurations required to deploy ProxySQL instances within the UPM ecosystem.
...
**Software Image Definition**: Provides the ProxySQL Community 2.7.2 container image specification and configuration templates.
...
helm install --namespace=upm-system upm-packages-proxysql-2.7.2 upm-packages/proxysql-2.7.2

# Verify package installation
helm status upm-packages-proxysql-2.7.2 --namespace=upm-system
```
...
Comprehensive parameter metadata with validation rules and bilingual documentation for all ProxySQL 2.7.2 configuration parameters.
